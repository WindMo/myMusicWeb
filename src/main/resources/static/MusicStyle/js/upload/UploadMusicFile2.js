    ...
    $(function() {
        $.getScript("http://cdn.staticfile.org/webuploader/0.1.0/webuploader.js", function () {
            ...
            uploader = WebUploader.create({
                ...
                server: '/Upload_File',
                method:'POST',
                // compress: false,  //为false时不压缩图片
                // runtimeOrder: 'flash',  //指定flash 还是  HTML5
            ...
            // 当有文件添加进来时执行，负责view的创建 ttile1
            function addFile( file ) {
                $.getScript("/MusicStyle/dist/id3-minimized.js", function () {


                    var files = file.files[0],
                        url = files.urn || files.name;
